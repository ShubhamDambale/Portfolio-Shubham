...
export const districts: District[] = [
  ...
  },
  {
    id: 'ai-lab',
    name: 'AI Lab',
    subtitle: 'What I am building toward',
    route: '/ai-lab',
    position: [-34, 0, 46],
    cameraPosition: [-19, 17, 60],
    cameraTarget: [-34, 7, 46],
    accent: '#f472b6',
    glyph: '🧪',
    keywords: ['ai', 'llm', 'cloud', 'system design', 'roadmap', 'future', 'lab', 'learning'],
    footprint: [18, 18],
    order: 5,
  },
  {
    id: 'data-center',
    name: 'Data Center',
    subtitle: 'How I architect systems',
    route: '/architecture',
    position: [36, 0, 48],
    cameraPosition: [21, 17, 62],
    cameraTarget: [36, 6, 48],
    accent: '#22d3ee',
    glyph: '🗄️',
    keywords: ['architecture', 'api', 'database', 'microservices', 'server', 'cloud', 'data center', 'system'],
    footprint: [22, 18],
    order: 6,
  },
  {
    ...
    subtitle: 'Impact & recognition',
    route: '/achievements',
    position: [-2, 0, -52],
    cameraPosition: [-2, 16, -32],
    cameraTarget: [-2, 6, -52],
    accent: '#fbbf24',
    glyph: '🏛️',
    keywords: ['achievements', 'awards', 'impact', 'badges', 'certificates', 'museum', 'results'],
    footprint: [22, 14],
    order: 7,
  },
  {
